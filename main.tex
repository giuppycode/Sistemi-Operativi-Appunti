...
\begin{center}
   ...
   \fbox{%
       \parbox{0.8\textwidth}{%
           ...
           Qualora vengano riscontrati errori o imprecisioni, siete liberi di modificare i file .tex e 
           aprire una pull request su GitHub per proporre le vostre correzioni, nell'interesse 
